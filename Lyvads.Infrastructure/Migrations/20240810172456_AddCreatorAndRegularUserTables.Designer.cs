...
namespace Lyvads.Infrastructure.Migrations
{
    ...
    [Migration("20240810172456_AddCreatorAndRegularUserTables")]
    partial class AddCreatorAndRegularUserTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lyvads.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("WalletId")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("210cf4db-a135-4f65-9221-6676cdddf7ca");
            ...
            modelBuilder.Entity("Lyvads.Domain.Entities.Creator", b =>
                {
                    b.HasOne("Lyvads.Domain.Entities.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Lyvads.Domain.Entities.Creator", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Lyvads.Domain.Entities.RegularUser", b =>
                {
                    b.HasOne("Lyvads.Domain.Entities.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Lyvads.Domain.Entities.RegularUser", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
