...
public interface IAdminPermissionsService
{
    ...
    Task<ServerResponse<RoleWithPermissionsDto>> CreateCustomRoleAsync(string roleName, AdminPermissionsDto permissionsDto);
    ...
    Task<ServerResponse<List<RoleWithPermissionsDto>>> GetAllRolesWithPermissionsAsync();
}
